...
public class X_Z_Picking extends PO implements I_Z_Picking, I_Persistent 
{
    ...
    public X_Z_Picking (Properties ctx, int Z_Picking_ID, String trxName)
    {
...
// PRODUCT
    ...
    /** Load Constructor */
    public X_Z_Picking (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_Picking[")
	...
	/** TipoPicking AD_Reference_ID=1000049 */
	public static final int TIPOPICKING_AD_Reference_ID=1000049;
	/** PRODUCTO = PRODUCT */
	public static final String TIPOPICKING_PRODUCTO = "PRODUCT";
	/** SOCIO DE NEGOCIO = PARTNER */
	public static final String TIPOPICKING_SOCIODENEGOCIO = "PARTNER";
	/** Set TipoPicking.
		@param TipoPicking 
		Tipos de Picking posibles
	  */
	public void setTipoPicking (String TipoPicking)
	{

		set_Value (COLUMNNAME_TipoPicking, TipoPicking);
	}

	/** Get TipoPicking.
		@return Tipos de Picking posibles
	  */
	public String getTipoPicking () 
	{
		return (String)get_Value(COLUMNNAME_TipoPicking);
	}
	...
	{
		if (Z_Picking_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_Picking_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_Picking_ID, Integer.valueOf(Z_Picking_ID));
	}
