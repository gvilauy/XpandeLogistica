...
/** Generated Model for Z_TransporteLog
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_TransporteLog extends PO implements I_Z_TransporteLog, I_Persistent 
{
    ...
    public X_Z_TransporteLog (Properties ctx, int Z_TransporteLog_ID, String trxName)
    {
      super (ctx, Z_TransporteLog_ID, trxName);
      /** if (Z_TransporteLog_ID == 0)
        {
			setIsOwn (true);
// Y
			setName (null);
    ...
    /** Load Constructor */
    public X_Z_TransporteLog (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_TransporteLog[")
	...
	public void setZ_TransporteLog_ID (int Z_TransporteLog_ID)
	{
		if (Z_TransporteLog_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_TransporteLog_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_TransporteLog_ID, Integer.valueOf(Z_TransporteLog_ID));
	}
